...
test.describe('GET',()=>{
    test('Found single user',async({request})=>{
        ...
        console.log("hearder [content]",header['content-type']);
        console.log("hearder sever",header.server);
...
test.describe('PATCH', () => {
    test('Partially update user data', async ({ request }) => {
        ...
        const updateData = {
            job: "nobody"  // Only updating the job field
        };
